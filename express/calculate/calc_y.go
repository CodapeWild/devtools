// Code generated by goyacc -o calc_y.go -p calc calc.y. DO NOT EDIT.
...
//line calc.y:23
		{
			fmt.Println(calcDollar[1].num.String())
		}
	case 3:
		calcDollar = calcS[calcpt-2 : calcpt+1]
//line calc.y:30
		{
			calcVAL.num = calcDollar[2].num
		}
	case 4:
		calcDollar = calcS[calcpt-2 : calcpt+1]
//line calc.y:34
		{
			calcVAL.num = calcDollar[2].num.Neg(calcDollar[2].num)
		}
	case 6:
		calcDollar = calcS[calcpt-3 : calcpt+1]
//line calc.y:41
		{
			calcVAL.num = calcDollar[1].num.Add(calcDollar[1].num, calcDollar[3].num)
		}
	case 7:
		calcDollar = calcS[calcpt-3 : calcpt+1]
//line calc.y:45
		{
			calcVAL.num = calcDollar[1].num.Sub(calcDollar[1].num, calcDollar[3].num)
		}
	case 9:
		calcDollar = calcS[calcpt-3 : calcpt+1]
//line calc.y:52
		{
			calcVAL.num = calcDollar[1].num.Mul(calcDollar[1].num, calcDollar[3].num)
		}
	case 10:
		calcDollar = calcS[calcpt-3 : calcpt+1]
//line calc.y:56
		{
			calcVAL.num = calcDollar[1].num.Quo(calcDollar[1].num, calcDollar[3].num)
		}
	case 12:
		calcDollar = calcS[calcpt-3 : calcpt+1]
//line calc.y:63
